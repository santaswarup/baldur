...
object ExperianSchema extends FileInputMeta with Serializable {
  ...
  override def mapping(input: Map[String, Any]): ActivityOutput = {
    ActivityOutput(
      ...
      streetPreDir = FileInputSupport.getStringOptValue(input, "streetPreDir"),
      streetName = FileInputSupport.getStringOptValue(input, "streetName"),
      streetPostDir = FileInputSupport.getStringOptValue(input, "streetPostDir"),
      streetSuffix = FileInputSupport.getStringOptValue(input, "streetSuffix"),
      streetSecondNumber = FileInputSupport.getStringOptValue(input, "streetSecondNumber"),
      streetSecondUnit = FileInputSupport.getStringOptValue(input, "streetSecondUnit"),
      streetHouseNum = FileInputSupport.getStringOptValue(input, "streetHouseNum"),
      msa = FileInputSupport.getStringOptValue(input, "msa"),
      pmsa = FileInputSupport.getStringOptValue(input, "pmsa"),
      dpv = FileInputSupport.getStringOptValue(input, "dpv"),
      countyCode = FileInputSupport.getStringOptValue(input, "countyCode"),
      censusBlock = FileInputSupport.getStringOptValue(input, "censusBlock"),
      censusTract = FileInputSupport.getStringOptValue(input, "censusTract"),
