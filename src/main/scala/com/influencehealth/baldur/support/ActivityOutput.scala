...
case class ActivityOutput(//person-columns
    ...
    childAgeBuckets: Option[Set[String]]=None,
...
object ActivityOutput {
  def mapJsonFields(activityOutput: ActivityOutput): Map[String, JsValue] = {
    Map(
      ...
      "ageGroup" -> jsStringFromOptionString(activityOutput.ageGroup),
      ...
      "language" -> jsNumberFromOptionInt(activityOutput.language),
      ...
      "estimatedHomeValue" -> jsStringFromOptionString(activityOutput.estimatedHomeValue),
      ...
      "childAgeBuckets" -> jsArrayFromOptionSetString(activityOutput.childAgeBuckets),
      ...
      "education" -> jsStringFromOptionString(activityOutput.education),
